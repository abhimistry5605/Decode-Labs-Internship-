...
import { Cpu, Layers, HeartHandshake } from 'lucide-react';
...
const Home = () => {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '60px' }}>
      {/* Hero Section */}
      <header className="hero-section" id="home-hero">
        <div className="hero-container container">
          {/* Hero Content Column */}
          <div className="hero-content">
            <span className="hero-badge">Welcome to EduCircuit Labs</span>
            <h1>
              Learn Practical Engineering With <span>Advanced Training Kits</span>
            </h1>
            <p>
              We provide curriculum-mapped industrial training kits to help engineering students improve practical skills in electronics, IoT, robotics, and embedded systems.
            </p>
      ...
      {/* Features Section */}
      <section className="container" id="home-features" aria-label="Key Features">
      ...
      <section className="container" id="home-sandbox" aria-label="Interactive Hardware Simulator" style={{ margin: '20px auto 40px auto' }}>
        <div className="section-header">
          <h2>
      ...
      <section className="container" id="home-spotlight" aria-label="Spotlight Kit Showcase" style={{ marginBottom: '40px' }}>
        <div className="section-header">
          <h2>
